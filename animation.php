	...
	<div class="row">
		...
		<div class="col s12">
			<div class="terminal">
				...
				<span class="value">"Aurélien FOUQUET"</span>
				;
				<br/>

				<span class="dollar"></span>
				<span class="var">situation</span>
				<span class="sign">=</span>
				<span class="value">"En recherche d'emploi en tant que développeuse WEB"</span>
				;
				<br/>
				...
				<span class="sign">=</span>
				<span class="value">"BAC +2 : BTS SIO option SLAM"</span>
				;
				<br/>

				<span class="dollar"></span>
				<span class="var">experienceTime</span>
				<span class="sign">=</span>
				...
				<span class="dollar"></span>
				<span class="var">skills</span>
				<span class="sign">=</span>
				<span class="fonction">array</span>(
				<span class="value">"PHP"</span>,
				<span class="value">"SYMPHONY2"</span>,
			...
			<div class="center">
				<svg id="hands-svg" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="196px" height="196px" viewBox="0 0 196 196" enable-background="new 0 0 196 196" xml:space="preserve">
					<g id="keyboard_full">
						<g id="keyboard">
